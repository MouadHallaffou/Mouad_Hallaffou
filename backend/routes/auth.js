...
// Register (Admin only)
router.post('/register', authenticateToken, requireAdmin, validateUser, handleValidationErrors, async (req, res) => {
  try {
...
// Update profile
router.put('/profile', authenticateToken, handleValidationErrors, async (req, res) => {
  try {
