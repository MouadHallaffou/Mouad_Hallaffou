    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        {Array.from({ length: 15 }).map((_, index) => (
          <motion.div
            key={index}
            className="absolute text-xs md:text-sm text-green-600/20 dark:text-green-400/30 font-mono"
            style={{
              top: `${Math.random() * 100}%`,
      ...
      >
            ...
            >
              ...
              <div className="font-mono text-xs md:text-sm">
                <div className="flex items-center">
                  ...
                  <motion.span
                    className={`w-1.5 h-3 bg-green-600 dark:bg-green-400 ml-1 ${isTyping ? 'animate-pulse' : ''}`}
            ...
            >
              ...
              <div className="relative card-modern p-8 max-w-md">
                <div className="text-center space-y-6">
                  ...
                  >
                    <motion.p
                      className="text-xs text-gray-400 dark:text-gray-500 uppercase tracking-wider font-medium"
                      initial={{ opacity: 0 }}
                      animate={{ opacity: 1 }}
        ...
        >
          <p className="text-gray-500 dark:text-gray-400 mb-1 text-xs">Scroll Down</p>
          <motion.div
            animate={{ y: [0, 8, 0] }}
